...
var Session = function (server, version, socket, options) {
  ...
  // Merge strategies define how we threat publication data for each collection
...
_.extend(Session.prototype, {
  ...
  getPublicationStrategy(collectionName) {
    return this._publicationStrategies[collectionName]
      || this.server.options.defaultPublicationStrategy;
  },

  _useCollectionView(collectionName) {
    return this.getPublicationStrategy(collectionName) === publicationStrategies.SERVER_MERGE;
  },
...
_.extend(Subscription.prototype, {
  ...
  _doAccountingForCollection(collectionName) {
    return this._session.getPublicationStrategy(collectionName) !== publicationStrategies.NO_MERGE_NO_HISTORY;
  },
